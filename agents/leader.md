...
| "publish to statsdoge" / "发布成卡片" / "make a StatsDoge card" / "ship + publish" | Publish add-on | scriber emits `statsdoge.md` + shipper Step 7c — `skills/statsdoge-publish/SKILL.md` |
