...
| "publish to statsotter" / "make a StatsOtter card" | Publish add-on | scriber writes `statsotter.md` to the repo root; shipper hands off to the StatsOtter plugin (StatsClaw does NOT upload) — `skills/statsotter-publish/SKILL.md` |
