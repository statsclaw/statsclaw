...
**Note**: Architecture diagrams and workflow logs are NOT stored in the target repo — they are synced to the workspace repo. No `MANIFEST.in` or setuptools exclusions are needed for these artifacts. See `skills/workspace-sync/SKILL.md`.
